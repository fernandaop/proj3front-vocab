...
export default function Due(props) {
  ...
  const [color7, setColor7] = React.useState(["gray", "gray", "gray", "gray", "gray"]);
  const [color8, setColor8] = React.useState(["gray", "gray", "gray", "gray", "gray"]);
  const [color9, setColor9] = React.useState(["gray", "gray", "gray", "gray", "gray"]);
  const [color10, setColor10] = React.useState(["gray", "gray", "gray", "gray", "gray"]);
  const [color11, setColor11] = React.useState(["gray", "gray", "gray", "gray", "gray"]);
  const [color12, setColor12] = React.useState(["gray", "gray", "gray", "gray", "gray"]);
  ...
  function compareWords1(palavrausuario, n_tentativa){
    let dicionario = ["", "", "", "", ""];
    let compara = props.palavra1;
    palavrausuario = palavrausuario.toLowerCase();
    compara = removerAcentos(compara);
    for (let i = 0; i < props.palavra1.length; i++) {
    ...
    if (tentativa === props.palavra1) {
      setAcabou(true);
      alert("Acertou!");
    }
  }
  function compareWords2(palavrausuario, n_tentativa){
    let dicionario = ["", "", "", "", ""];
    let compara = props.palavra2;
    palavrausuario = palavrausuario.toLowerCase();
    compara = removerAcentos(compara);
    ...
    console.log(dicionario);
    if (n_tentativa === 1){
      setColor7(dicionario);
    } else if (n_tentativa === 2){
      setColor8(dicionario);
    } else if (n_tentativa === 3){
      setColor9(dicionario);
    } else if (n_tentativa === 4){
      setColor10(dicionario);
    } else if (n_tentativa === 5){
      setColor11(dicionario);
    } else if (n_tentativa === 6){
    ...
    if (e.keyCode === 13 || e.keyCode === undefined) {
      ...
      if (tentativa.length < 5) {
        ...
        if (tentativa1 === "") {
          ...
          compareWords1(tentativa, 1);
          compareWords2(tentativa, 1);
        } else if (tentativa2 === "") {
          setTentativa2(tentativa.toLowerCase());
          compareWords1(tentativa, 2);
          compareWords2(tentativa, 2);
        } else if (tentativa3 === "") {
          setTentativa3(tentativa.toLowerCase());
          compareWords1(tentativa, 3);
          compareWords2(tentativa, 3);
        } else if (tentativa4 === "") {
          setTentativa4(tentativa.toLowerCase());
          compareWords1(tentativa, 4);
          compareWords2(tentativa, 4);
        } else if (tentativa5 === "") {
          setTentativa5(tentativa.toLowerCase());
          compareWords1(tentativa, 5);
          compareWords2(tentativa, 5);
        } else if (tentativa6 === "") {
          setTentativa6(tentativa.toLowerCase());
          compareWords1(tentativa, 6);
          compareWords2(tentativa, 6);
        }
      setTentativa("");
    }
  } else if(e.keyCode === 8){
  ...
  function inputOrTentativaDue1() {
    if(tentativa1 === ""){
      ...
      return (
        <div className="tentativa">
        <div className={`${color7[0]}`}>{tentativa1[0]}</div>
        <div className={`${color7[1]}`}>{tentativa1[1]}</div>
        <div className={`${color7[2]}`}>{tentativa1[2]}</div>
        <div className={`${color7[3]}`}>{tentativa1[3]}</div>
        <div className={`${color7[4]}`}>{tentativa1[4]}</div>
      </div>
      );
    }
  }
  function inputOrTentativaDue2() {
    if(tentativa1 !=="" && tentativa2 === "" && acabou === false){
      ...
      return (
        <div className="tentativa">
        <div className={`${color8[0]}`}>{tentativa2[0]}</div>
        <div className={`${color8[1]}`}>{tentativa2[1]}</div>
        <div className={`${color8[2]}`}>{tentativa2[2]}</div>
        <div className={`${color8[3]}`}>{tentativa2[3]}</div>
        <div className={`${color8[4]}`}>{tentativa2[4]}</div>
      </div>
      );
    }
  }
  function inputOrTentativaDue3() {
    if(tentativa1 !=="" && tentativa2 !== "" && tentativa3 === "" && acabou === false){
      ...
      return (
        <div className="tentativa">
        <div className={`${color9[0]}`}>{tentativa3[0]}</div>
        <div className={`${color9[1]}`}>{tentativa3[1]}</div>
        <div className={`${color9[2]}`}>{tentativa3[2]}</div>
        <div className={`${color9[3]}`}>{tentativa3[3]}</div>
        <div className={`${color9[4]}`}>{tentativa3[4]}</div>
      </div>
      );
    }
  }
  function inputOrTentativaDue4() {
    if(tentativa1 !=="" && tentativa2 !== "" && tentativa3 !== "" && tentativa4 === "" && acabou === false){
      ...
      return (
        <div className="tentativa">
        <div className={`${color10[0]}`}>{tentativa4[0]}</div>
        <div className={`${color10[1]}`}>{tentativa4[1]}</div>
        <div className={`${color10[2]}`}>{tentativa4[2]}</div>
        <div className={`${color10[3]}`}>{tentativa4[3]}</div>
        <div className={`${color10[4]}`}>{tentativa4[4]}</div>
      </div>
      );
    }
  }
  function inputOrTentativaDue5() {
    if(tentativa1 !=="" && tentativa2 !== "" && tentativa3 !== "" && tentativa4 !== "" && tentativa5 === "" && acabou === false){
      ...
      return (
        <div className="tentativa">
        <div className={`${color11[0]}`}>{tentativa5[0]}</div>
        <div className={`${color11[1]}`}>{tentativa5[1]}</div>
        <div className={`${color11[2]}`}>{tentativa5[2]}</div>
        <div className={`${color11[3]}`}>{tentativa5[3]}</div>
        <div className={`${color11[4]}`}>{tentativa5[4]}</div>
      </div>
      );
    }
  }
  function inputOrTentativaDue6() {
    if(tentativa1 !=="" && tentativa2 !== "" && tentativa3 !== "" && tentativa4 !== "" && tentativa5 !== "" && tentativa6 === ""  && acabou === false){
      ...
      return (
        <div className="tentativa">
        <div className={`${color12[0]}`}>{tentativa6[0]}</div>
        <div className={`${color12[1]}`}>{tentativa6[1]}</div>
        <div className={`${color12[2]}`}>{tentativa6[2]}</div>
        <div className={`${color12[3]}`}>{tentativa6[3]}</div>
        <div className={`${color12[4]}`}>{tentativa6[4]}</div>
      </div>
      );
    }
  }
  function mostrarPalavra1() {
    if (acabou) {
      return (<div className="palavra">
        <div className="palavra">{props.palavra1}</div>
      </div>);
    } else {
      return (<div></div>);
    }
  ...
  <div>
    ...
    <div className="linha">
      ...
      <div className="caixa">
        {mostrarPalavra2()}
        {inputOrTentativaDue1()}
        {inputOrTentativaDue2()}
        {inputOrTentativaDue3()}
        {inputOrTentativaDue4()}
        {inputOrTentativaDue5()}
        {inputOrTentativaDue6()}
      </div>
    </div>
